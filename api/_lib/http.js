...
// (api/_lib/cards.js, plus scripts/warm-previews.mjs, which imports it rather
// than keeping a fourth copy). Every function here runs on an
// UNAUTHENTICATED path where a novel query is a cache miss that fans out to
// a third-party host (statsapi) — bound each call
