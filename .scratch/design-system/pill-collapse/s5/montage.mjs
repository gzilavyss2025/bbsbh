// Before/after contact sheet for slice 5 (#1131), copied from ../s4/montage.mjs: one row per target and
...
<table><tr><th>${state || 'in its row'}</th><th>before (main)</th><th>after (slice 5)</th></tr>
