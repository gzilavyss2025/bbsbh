        ...
        runtimeCaching: [
          {
            ...
            urlPattern: ({ url }) =>
              /^\/data\/(?:umpire-accuracy|top-prospects|minors-leaders|all-star-rosters|fouls|workload|career-matchups|postseason-odds|postseason-history|team-score|season-score|milestones|savant-percentiles)\.json$/.test(
                url.pathname,
              ) ||
