  ...
  return (
    <li className="horizontile">
      ...
      <div className="horizontile__statbox">
        <span className="horizontile__statv">{p.trend.standing}</span>
        <span className="horizontile__statk">
          &#9650; {p.trend.movement.amount} pts
...
function MilestoneTile({ p }) {
  return (
    <li className="horizontile">
      ...
      <div className="horizontile__statbox">
        <span className="horizontile__statv">On rehab</span>
        <span className="horizontile__statk">{monthDay(p.since) ? `Since ${monthDay(p.since)}` : DASH}</span>
      </div>
    </li>
  )
}
...
// snapshot RehabPage reads). Renders nothing when both are empty rather than
// an empty-state card — a farm system with no one trending and no one
