...
function SidePanel({ side, teamId, name, abbreviation, values, landed, placements, inkOverride, onField, onReset }) {
  ...
  //
  // It matters twice over now that the INK row at the foot of this card is
  // judged on these same two stamps: a filled band roughly doubles how much ink
  // is on the page, which is the whole thing that row asks you to look at.
  const game = {
    ...PREVIEW_GAME,
