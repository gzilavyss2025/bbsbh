...
// player-page "worth mentioning" distance (tight — this season or next).
// `farWindow` is the wider distance the league-wide Milestone Watch page (a
// dedicated page, not a one-line aside) uses instead, covering a player who's
// a couple of full seasons out rather than just the next few weeks.
...
// All three windows are a first cut — hits/HR/300-win/3000-K are well-worn
