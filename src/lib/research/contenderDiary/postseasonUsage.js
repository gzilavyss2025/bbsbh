...
export const postseasonUsageEntry = {
  ...
  verdict: 'holds',
  question:
    'Spike #1 found that older rosters go deeper in October, but a team’s age there counted every player on its full-season roster — including a trade-deadline rental who might never have gotten into a playoff game. Does the finding survive weighting a team’s age by who ACTUALLY played once October started?',
  headline:
  ...
  sections: [
    {
      ...
      prose: [
        'For every team that made the playoffs, its age was recomputed using only the players who actually pitched or batted in that team’s postseason games, weighted by how much they played THERE instead of during the regular season.',
      ],
      table: {
      ...
      proseAfter: [
        'If the original finding were mostly padded by veterans who never got into a playoff game, this number would have moved a lot. It did not. And restricted to just the 250 team-seasons that made the playoffs, pitching age measured this way still predicts how far a team goes (a real, checked result); batting age does not — the same split spike #1 already found.',
      ],
    },
    {
      id: 'the-trap',
  ...
  caveats: [
    ...
    'Both checks here only cover the 250 team-seasons that made the playoffs — there is nothing to measure for a team that never got to October.',
  ],
  open: [
  ...
  technical: [
    'Postseason-actual age: PA/IP-weighted mean of each player\'s REGULAR-SEASON age (statsapi\'s boxscore endpoint carries no age field), weighted by his POSTSEASON PA/IP for that team instead of his regular-season PA/IP. n=250 playoff team-seasons.',
    'Spearman rho vs. the 0-5 ladder, restricted to playoff teams: postseasonBattingAgeRel 0.0882 (permutation p=0.1692, within-season shuffle, 5,000 draws), postseasonPitchingAgeRel 0.1731 (p=0.0070).',
