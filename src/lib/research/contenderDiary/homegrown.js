...
export const homegrownEntry = {
  ...
  headline:
    'No, not on the main question — a homegrown roster does not clearly predict how far a playoff team goes, and the correlation is too weak and too inconsistent to call a real effect. But it does separate division winners from wild-card teams: among the 178 clubs that already made the playoffs, division winners ran about 5 percentage points more homegrown than wild-card teams, on both the hitting and pitching side. That is the mirror image of the roster-age spike, which found the opposite split — age said something about making it in, nothing about which kind of playoff team you were; homegrown share says nothing about going deep, but something about how you got there.',
  sections: [
    {
      id: 'the-null',
    ...
    },
    {
      ...
      prose: [
        'Restricted to the 178 team-seasons that already made the playoffs, division winners had a noticeably more homegrown roster than teams that got in on a wild card — on BOTH sides of the ball, at almost exactly the same size.',
      ],
      table: {
        caption: 'Among playoff teams only: division winners vs. wild-card teams',
  ...
  technical: [
    ...
    'Band-difference permutation p-values (within-season shuffle, 5,000 draws): made playoffs vs. not, p=0.1506 (hit) / 0.2858 (pit); LCS+ vs. not, p=0.6098 / 0.1362; WS winner vs. not, p=0.7314 / 0.5020 (n=19 champions).',
    'Division winner vs. wild card among the 178 playoff teams: +5.1pp hitting (p=0.0416), +5.2pp pitching (p=0.0374) — both significant at the conventional threshold.',
