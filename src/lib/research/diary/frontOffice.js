...
export const frontOfficeEntry = {
  ...
  verdict: 'agenda',
  question:
    'Eight studies, and four of them end in no. On Monday somebody has to sit in a room and say what this bought us and what should be built next. So: what does the stack say that no single entry says?',
  headline:
    'That there is no secret in how other clubs develop players — or none that can be seen from outside. A club’s name does not predict how fast its prospects move. Building from within wins no games. The quality of a farm does not separate the four clubs left standing in October; the headcount does. Take all the nos out and two things are left that nobody here has priced: the job above the prospect, and the fact that every promotion is a rival front office saying out loud what it believes.',
  sections: [
    {
      id: 'the-nothings',
      heading: 'Start with the four nos, because they are the most valuable thing on this page',
      prose: [
        'Four of these entries end in no, and a fifth takes back part of a sixth. Read as a return on four months of work that looks thin. From this chair it is the opposite. Every no on the list is something people in this game say with confidence, and now we know what saying it is worth.',
      ],
      table: {
        ...
        rows: [
          ...
          [
            ...
            'A measuring fault. Two clipped years at the front of the record, one missing season, and our own filter deleting what the missing season stretched',
          ],
          [
      ...
      proseAfter: [
        'Every one of those is a belief somebody would act on, and two of them have been said in this building. The value of a no is that it stops you paying for something.',
        'It also points somewhere. If nothing about how a club is run shows up from outside, then the edge is not in being a better development shop than the club across the table. It is in the two places this work kept brushing past on its way somewhere else.',
      ],
    },
    {
      id: 'the-queue',
      ...
      prose: [
        ...
        'The homegrown entry arrives at the same place from the other end. In a season where a club carried more of its own men in the majors than that club normally carries, its prospects sat about a month longer at Double-A the year after. That entry is careful to call it a pattern rather than a mechanism, and it names the natural story anyway: a club with eight homegrown regulars has no openings, and a prospect with nowhere to go stays where he is.',
        'Anybody who has spent a season around a farm system has watched that happen. It has a name in every clubhouse. What it does not have anywhere is a number.',
        'That gap is worth money in both directions. If the man ahead of him is the biggest single thing setting a prospect’s clock, then a blockage is a price. Ours is a cost we pay every year without writing it down. Somebody else’s is a discount on a player who is not actually any worse.',
      ],
    },
    {
      id: 'revealed-opinion',
      ...
      prose: [
        ...
        'The work already hints that the signal is more than the box score. Most of the gap between the fast movers and the slow ones survives after accounting for how the men were hitting at the time. Most of it — not all of it. Whatever is left over is another club’s scouting report, and it is free.',
      ],
    },
    {
      id: 'tampa',
      ...
      prose: [
        ...
        'The entry calls that a footnote rather than a feature. For a page in this app that is the right call. For a front office it is not. The two results are not in conflict — twenty-nine clubs doing roughly the same thing and one doing something else is precisely what "clubs as a group explain almost nothing, and this club is slow under every method" looks like.',
        'So the question I want asked is not whether. It is what the one club is doing, which is smaller and far more answerable than the question the study was originally given.',
      ],
    },
    {
      id: 'small-effects',
      ...
      prose: [
        'Three entries deflate themselves, and the deflation is always the same sentence: this improves your guess about any particular prospect by less than half of one percent. That is fair and necessary when the question is whether to build a feature out of it. I think it is the wrong frame for the room I sit in.',
        'We do not make one decision. We make a couple of hundred a year — who to protect, who to option, who to ask for in the third slot of a trade, which of two similar arms to take at pick 40. A thumb on the scale, applied to enough of those, is how this job gets won. Which is why a finding being real matters more to me than a finding being large.',
    ...
    },
    {
      ...
      prose: [
        'Seven, ordered by what I would fund first rather than by how hard they are. Three of them need something this club does not currently hold, and I have said which.',
      ],
      points: [
        'PRICE THE BLOCKAGE. For every Triple-A stay, describe the job above the man: who holds it, how he is playing, how many years he is signed for, whether he can be moved. Then ask whether that description predicts the length of the stay better than the prospect’s own line does. The Triple-A stay is the widest and most job-shaped number in the whole benchmark, so if the answer is anywhere it is there. Get it and we can price a blocked prospect — ours, and everybody else’s. This is the one I would fund first.',
        'BUILD THE BUST COHORT. Every single entry on this page carries the same confession: everybody in it reached the majors. Eight studies, one missing half, and it is the half this job is about. The level-tenure entry says why nobody has done it — there is no clean signal for when a career ended. So find a dirty one and defend it in public. Released, with no affiliated game in the two following seasons; no affiliated game for two seasons at all; either of those past an age floor. Publish how far the answers move when the rule changes. The cheap first test is already written down in the rookie-traits entry: minor leaguers who never graduated still have a listed height and weight, so compare the heavy men who made it against the heavy men who did not. That tells us inside a week whether size is an edge or just what a club looks for when it decides who gets the at-bats.',
        'SCORE THE SURPRISE. The benchmark already says what a normal stay looks like at each rung, so the difference between a man’s real clock and the benchmark one is computable today. Call it surprise. Two questions follow. Does surprise predict what a player does in the majors once his minor-league line is accounted for? And whose surprises pay off? An answer to the second is a scouting report on twenty-nine rival departments, built entirely out of public paperwork, and I do not believe anybody has one.',
        'ASK WHAT TAMPA BAY IS DOING. Not whether — that is settled across seven ways of counting. Where does the slowness live: one level, one position group, pitchers only, the forty-man or everybody else? Does it arrive at the same point of the season each year? Then the question that decides whether we copy it or ignore it: are their graduates any better for the wait? Match Rays graduates against faster men from other clubs on level, age and minor-league rate, and compare the first six seasons. Patience that pays and patience that is merely slow look identical until somebody does that.',
        'TEST THE PITCHING-LAB EXPLANATION. The unusually light and the unusually heavy pitcher both wait about a third of a season longer, and the worry attached to that finding is that the whole effect sits in 2018 through 2023. I do not think the dates are a coincidence, and I do not think the cause is prejudice about odd bodies. Those are the years the pitching labs opened. The test: a body that gets sent away and remodelled should come back throwing differently. We already pull the arsenal reading at debut. If the odd-bodied arms that waited longest arrive throwing harder than their signing reports would have predicted, the extra time was investment and those are arms to buy. If they arrive throwing exactly what they always threw, it is a club being slow with a body it does not recognise — which is a market to shop in.',
        'DECOMPOSE THE THREE GRADUATES. The final-four entry says the clubs that get there raised 26 major leaguers over five years against 23. Three men, and it is the only club-level thing on this page that separates October. As it stands it is a finding and not an instruction. Where do the extra three come from — more international signings, more picks, better retention, fewer washouts out of the same intake? That decomposition turns it into a budget line, and a budget line is a thing I can argue for in November.',
    ...
    },
    {
      ...
      table: {
        ...
        rows: [
          [
            'Price the blockage',
            'The job above him adds nothing once the prospect’s own line is already in the model',
          ],
          [
            'Build the bust cohort',
            'The answers move every time the rule for "his career ended" changes, and no rule can be defended over the others',
          ],
          [
            'Score the surprise',
            'Surprise predicts nothing beyond the minor-league line, or no club’s surprises are worth more than any other club’s',
          ],
          [
          ...
          [
            ...
            'The extra three are spread evenly across every acquisition channel, so there is nothing in particular to buy',
          ],
          [
  ...
  caveats: [
    ...
    'The "small edge, many decisions" argument is mine and it is not evidenced anywhere on this page. It is entirely possible that an edge of half of one percent is swamped by the noise inside every one of those two hundred decisions and never adds up to anything at all. Somebody should check that before I say it in a meeting again.',
