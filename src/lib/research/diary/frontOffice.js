...
export const frontOfficeEntry = {
  ...
  technical: [
    ...
    'The three asks that need data the club does not hold are the blockage (incumbent job description per stay), the bust cohort (players who never graduated, plus a defensible exit rule), and the payroll purchase. The other four — surprise, Tampa Bay, the pitching lab and the graduate decomposition — are refits or matches over data already in the repo. Ordering in the prose is by expected value, not by this split.',
  ],
}
