...
export const HOW_TO_READ = [
  ...
  'All of it is about the minor leagues: how long a prospect sits at a level, whether some clubs move men faster than others, and whether any of it is worth anything. None of it touches a live game, and nothing here can spoil one.',
  'Every entry ends with a list of what is missing from it. Those lists are not throat-clearing. In three of the four, the missing thing is the likeliest reason the finding is wrong.',
]
