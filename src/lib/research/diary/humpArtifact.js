...
export const humpArtifactEntry = {
  ...
  headline:
    'Nothing happened. The slowdown is an artifact of how we were measuring, not a change in how clubs behaved. And while checking it, a second and worse problem turned up: about one duration in eight was counting a big-leaguer’s trips up and down from Triple-A as if it were a prospect climbing the ladder.',
  sections: [
    {
      id: 'per-year',
    ...
    },
    {
      ...
      points: [
        'The transaction wire barely exists before 2009. There are 457 minor-league assignment records for the whole stretch from 1997 to 2008, against 290,690 from 2009 onward. Dating a stay needs a record at both ends of it, so a stay that ended in 2009 can only be measured back as far as the wire goes — at most about nine months, whatever really happened. Those early years are not short. They are clipped. 2011 is the first year that can hold a full-length stay, which is where the cutoff comes from.',
        'There was no minor-league season in 2020. Any stay straddling that year is stretched by an empty calendar — 218 of them.',
        'And then our own rules threw the stretched ones out. The pipeline discards any stay longer than 900 days as implausible, which deleted 48 of the stints the lost season had inflated, most of them ending in 2021. So the missing season pushes the late bucket up and our own cutoff pulls it back down. Neither has anything to do with how fast clubs promote.',
      ],
    },
    {
      id: 'corrected',
      ...
      proseAfter: [
        'The peak shrinks from 23 percent above the early years to 6 or 10 percent. The last two rows handle the pandemic in deliberately opposite ways — one adjusts for it, one refuses to adjust and throws the disrupted years out — so the answer does not depend on the adjustment being right.',
      ],
    },
    {
      id: 'wire-free',
    ...
    },
    {
      ...
      points: [
        'That clubs matter a little, in aggregate. The earlier entry said organization carries a real if tiny effect. Once the era corrections come off, the two independent ways of testing that stop agreeing — one still says yes, the other says no, and the share of the variation attributable to the club falls to roughly nothing. When two honest methods split, the honest report is that it is unsettled, not that one of them won.',
        'That a certain statistical correction always makes results less certain. The earlier adversarial review stated this as an established fact and marked it confirmed. It is not true here: for 18 of 30 clubs the correction made the result MORE certain, not less. That is why the Rays get stronger under it while Washington gets weaker, and why the two methods produce opposite lists of notable clubs. Never assume which way a correction pushes. Measure it.',
      ],
    },
    {
      id: 'tampa-holds',
  ...
  caveats: [
    'The stat-line check stops at 2018 on both ends, and the boundary is forced rather than chosen: it counts seasons, and 2020 had no season to count. So it speaks to the supposed rise into 2016–2018 and says nothing about 2019 or 2020. That is a real gap and it is not papered over.',
    'The wire got much denser over the same years — 13,731 assignment records in 2011 against 27,284 in 2019 — and denser records do track longer measured stays. But density rises almost perfectly with the calendar, so this cannot tell "better records, longer measurements" apart from any other trend across those nine years. It is offered as consistent with the explanation, not as proof of it.',
    'The obvious objection — "you just deleted the rows that disagreed with you" — was tested instead of argued. Two hundred random deletions of the same size were run for comparison. The targeted removal sits at the bottom of that range on every measure, while random deletions leave the answer where it started. The rows that came out were not a random slice.',
  ],
  open: [
