...
| `customMarks.js` | The library of those recolored marks, and which treatment wears one — plus the City Connect bar's own pasted-SVG masthead mark, under a synthetic key (`data/custom-marks.json`; ADR-0031's addendum) |
