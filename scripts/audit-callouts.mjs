...
const KNOWN_KINDS = [
  ...
  'vsTeam', 'scoringFirst', 'oppScoringFirst', 'starterRec', 'dayOfWeek', 'afterInning',
  'scorelessThrough', 'bothScoreless', 'inningRunDiff', 'tto', 'ttoPitches',
...
const DATA_GATES = {
  ...
  afterInning: (b) => teamRec(b, 'trailAfterFull'),
