...
- **Quality** measures how strongly the club has played. It blends 60% actual
  wins with 40% Pythagorean wins derived from park-adjusted run differential,
  applies a capped strength-of-schedule nudge from opponents' own season
  winning percentage, then centers and dampens the result around a 5.0
  average club.
